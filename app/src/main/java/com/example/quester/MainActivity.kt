...
class MainActivity : ComponentActivity() {
    ...
    private suspend fun initializeShop(database: AppDatabase) {
        ...
        database.shopDao().upsertItems(
            listOf(
                ShopItem(itemId = "frame_mago", name = "Cornice del Mago", price = 30, description = "Cornice con rune magiche e stelle cadenti", iconName = "ic_frame_wizard"),
                ShopItem(itemId = "frame_cavaliere", name = "Cornice del Cavaliere", price = 30, description = "Cornice con spade incrociate e scudi", iconName = "ic_frame_knight"),
                ...
                ShopItem(itemId = "hat_mago", name = "Cappello del Mago", price = 100, description = "Cappello a punta con stelle magiche", iconName = "ic_char_wizard"),
                ShopItem(itemId = "staff_mago", name = "Bastone del Mago", price = 100, description = "Bastone con gemma magica incantata", iconName = "ic_char_weapon_staff"),
                ShopItem(itemId = "gun_spaziale", name = "Space Pistol", price = 100, description = "High-tech laser pistol", iconName = "ic_gun_spaziale"),
                ShopItem(itemId = "sword_cavaliere", name = "Spada del Cavaliere", price = 100, description = "Spada luminosa forgiata nell'acciaio", iconName = "ic_char_weapon_blade"),
                ShopItem(itemId = "elmo_cavaliere", name = "Elmo del Cavaliere", price = 100, description = "Elmo con visiera protettiva", iconName = "ic_char_helm"),
                ...
                ShopItem(itemId = "theme_fantasy", name = "Tema Bacheca Fantasy", price = 500, description = "Stile pergamena antica e rune magiche", iconName = "ic_dragon"),
                ShopItem(itemId = "reward_corona", name = "Corona dell'Eroe", price = 0, description = "★ Riservata ai veri Campioni! ★", iconName = "ic_crown"),
                ShopItem(itemId = "reward_tema_regale", name = "Tema Regale", price = 0, description = "✦ Tema esclusivo per i Re di Quester", iconName = "ic_throne")
            )
        )
    }
