            ...
            LaunchedEffect(Unit) {
                ...
                database.shopDao().upsertItems(
                    listOf(
                        ...
                        ShopItem(itemId = "gun_spaziale", name = "Space Pistol", price = 100, description = "High-tech laser pistol", iconName = "shopping_cart"),
                        ...
                        ShopItem(itemId = "visor_futuristico", name = "Visore Futuristico", price = 100, description = "Visore high-tech con HUD integrato", iconName = "shopping_cart"),
